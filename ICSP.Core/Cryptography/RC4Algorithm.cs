...
{
  public static class RC4Algorithm
  {
    /// <summary>
    ...
    public static byte[] ApplyDirect(byte[] data, byte[] privatKey)
    {
      // Initialize S-Box direct
      int[] S = new int[256];

      Array.Copy(privatKey, 0, S, 0, privatKey.Length);
