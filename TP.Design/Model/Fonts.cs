...
namespace TP.Design.Model
{
  public class Fonts : List<Font>
  {
    ...
    public Fonts()
    {
      ...
      /*
      Cannot deserialize the current JSON object (e.g. {"name":"value"}) into type 'TP.Design.Model.Fonts' because the type requires a JSON array (e.g. [1,2,3]) to deserialize correctly.
