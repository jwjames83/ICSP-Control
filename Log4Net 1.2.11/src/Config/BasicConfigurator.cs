...
{
	/// <summary>
	/// Use class to quickly configure a <see cref="Hierarchy"/>.
	/// </summary>
	/// <remarks>
	/// <para>
	...
	/// </para>
	/// <para>
	/// Only one appender can be configured using configurator.
	...
	public sealed class BasicConfigurator
    {
		...
		/// <remarks>
		/// <para>
		/// Uses a private access modifier to prevent instantiation of class.
		/// </para>
		/// </remarks>
